...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    try {
      ...
      if (!membersTable.demographic) {
        await queryInterface.addColumn('members', 'demographic', {
      ...
      await queryInterface.addIndex('attendance', ['memberId'], { transaction });
      await queryInterface.addIndex('attendance', ['date'], { transaction });
  ...
  async down (queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('members', 'demographic', { transaction });
